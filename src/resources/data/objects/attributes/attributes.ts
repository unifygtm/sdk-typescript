...
export namespace UAttribute {
  ...
  export interface UnionMember11 {
     ...
     */
    cardinality: AttributesAPI.UReferenceCardinality;
    ...
    /**
     * The optional related attribute on the referenced object. When this exists, the
     * relationship between the two objects is bidirectional.
     */
    related_attribute: AttributesAPI.URelatedReferenceAttribute | null;
 ...
 */
export interface UAttributeOptionUpdateItem {
  /**
...
export declare namespace AttributeCreateParams {
  ...
  export interface UObjectsUReferenceAttribute {
     ...
     * relationship between the two objects is bidirectional.
     */
    related_attribute: URelatedReferenceAttribute | null;
...
export declare namespace AttributeUpdateParams {
  ...
  export interface UObjectsUMultiSelectAttributeUpdate {
    /**
     * Path param
     */
    object_name: string;
     ...
     */
    options: Array<UAttributeOptionUpdateItem>;
  }
  ...
  export interface UObjectsUReferenceAttributeUpdate {
    /**
     * Path param
     */
    object_name: string;
    ...
    /**
     * Body param: The cardinality of the reference attribute.
     */
    cardinality: UReferenceCardinality;
    ...
    /**
     * Body param: The optional related attribute on the referenced object. When this
     * exists, the relationship between the two objects is bidirectional.
     */
    related_attribute: URelatedReferenceAttribute | null;
  ...
  export interface UObjectsUSelectAttributeUpdate {
    /**
     * Path param
     */
    object_name: string;
