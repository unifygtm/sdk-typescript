...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'post',
  httpPath: '/objects/{object_name}/find-unique',
  operationId: 'find_unique_object_record',
};

export const tool: Tool = {
  name: 'find_unique_objects',
  description:
...
export const handler = async (client: Unify, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(
    await maybeFilter(jq_filter, await client.objects.findUnique(object_name, body)),
  );
};
