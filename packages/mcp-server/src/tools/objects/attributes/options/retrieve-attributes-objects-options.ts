...
export const tool: Tool = {
  name: 'retrieve_attributes_objects_options',
  description:
  ...
  inputSchema: {
    ...
    required: ['object_name', 'attribute_name', 'option_name'],
  },
  annotations: {
    readOnlyHint: true,
  },
...
export const handler = async (client: Unify, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(
    await maybeFilter(jq_filter, await client.objects.attributes.options.retrieve(option_name, body)),
  );
};
